...
parser.add_argument("--checkpoint", default="./runs_organ/run9-3/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="run9-3b", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./runs_organ/run9-3/", type=str, help="pretrained checkpoint directory"
)
...
parser.add_argument("--additional_information", default="organ_inter3", help="additional information provided to segmentation model")
