...
parser.add_argument("--checkpoint", default="./runs/rerun18-2b/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="run5-2", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
