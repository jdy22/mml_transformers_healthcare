...
parser.add_argument("--checkpoint", default="./runs_organ/run12-3/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="run12-3b", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./runs_organ/run12-3/", type=str, help="pretrained checkpoint directory"
)
