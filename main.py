...
parser.add_argument("--checkpoint", default="./runs_organ/run12-2/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="run12-2b", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./runs_organ/run12-2/", type=str, help="pretrained checkpoint directory"
)
