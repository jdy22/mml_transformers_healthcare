...
parser.add_argument("--checkpoint", default="./runs_modality/rerun2-2/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="rerun2-2b", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./runs_modality/rerun2-2/", type=str, help="pretrained checkpoint directory"
)
