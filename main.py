...
parser.add_argument("--checkpoint", default="./runs_modality/run3-3/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="run3-3b", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./runs_modality/run3-3/", type=str, help="pretrained checkpoint directory"
)
