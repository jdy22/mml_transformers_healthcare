...
parser.add_argument("--checkpoint", default="./runs/rerun18-3/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="run5-3", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
