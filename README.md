...
```
cd existing_repo
git remote add origin https://gitlab.doc.ic.ac.uk/g22mai03/individual_project.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.doc.ic.ac.uk/g22mai03/individual_project/-/settings/integrations)
